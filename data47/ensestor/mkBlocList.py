...
# Arguments
############
(noms_fichiers, options) = utils.myTools.checkArgs( ["phylTree.conf", "diagsList"], [("ancestr",str,""), ("genesFile",str,"~/work/data/genes/genes.%s.list.bz2"), ("ancGenesFile",str,"~/work/data/ancGenes/ancGenes.%s.list.bz2")], "Cree la liste des blocs de syntenie (y compris les genes singletons)" )
