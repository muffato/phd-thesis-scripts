BEGIN {
	...
	print "%%Pages: 1";
	print "%%BoundingBox: 0 160 640 840"
...
END{
	# Av -> Ahp
	rline(3.5, 23, 0, -4, "black", 0.05)
	arrow(3.4, 19, 0, 0.2, -0.1, "black")
	rline(11.8, 23, 0, -4, "black", 0.05)
	arrow(11.7, 19, 0, 0.2, -0.1, "black")
	# Ahp -> M
	rline(3.5, 14, 0, -4, "black", 0.05)
	arrow(3.4, 10, 0, 0.2, -0.1, "black")
	rline(11.8, 14, 0, -4, "black", 0.05)
	arrow(11.7, 10, 0, 0.2, -0.1, "black")
	# Av -> T
	rline(19.5, 23, 0, -13, "black", 0.05)
	arrow(19.4, 10, 0, 0.2, -0.1, "black")

	
	#arrow(24.4, 11.5, -0.2, 0, 0.1, "black")
	
	print "/Arial-Bold-Italic findfont";
	print "12 scalefont";
	print "setfont";
	text(18.5, 6, "Tetraodon", "black")
	text(11, 6, "Poulet", "black")
	text(2.8, 6, "Homme", "black")
	text(8, 29, "Ancetre des vertebres", "black")
	text(5, 21, "Ancetre des amniotes", "black")
	
	print "/Arial-Italic findfont";
	print "10 scalefont";
	print "setfont";
	# txt Av
	text(9.2, 28.6, "-450 Ma", "black")
	# txt Ahp
	text(6.3, 20.6, "-310 Ma", "black")
...
function arrow(X,Y,L,H,P,C){
  print "newpath";
  print X, "cm",Y,"cm","moveto";
  print 0, "cm", L, "cm", "rlineto";
  print H/2, "cm", P, "cm", "rlineto";
  print H/2, "cm", -P, "cm", "rlineto";
  print 0, "cm", -L, "cm", "rlineto";
  print "closepath";
  print "gsave";
