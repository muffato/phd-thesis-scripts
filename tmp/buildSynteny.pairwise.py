...
def compare(e1, e2, toStudy):
	...
	for ((c1,d1),(c2,d2),daa) in myDiags.calcDiags(dicGenomes[e1], dicGenomes[e2], genesAnc[phylTree.dicParents[e1][e2]], \
		...
		for anc in toStudy:
			...
			la.append( anc + "=" + utils.myFile.myTSV.printLine(da, " "))
		res.append(utils.myFile.myTSV.printLine(la, "|"))
