...
def fileIterator(nom):
	...
	for ligne in MySQLFileLoader(f):
		yield ligne
	f.close()
...
(noms_fichiers, options) = utils.myTools.checkArgs( \
	...
	("OUT.parasFile",str,"~/work/data/paralogs/paras.%s.list.bz2"), \
	("IN.ensemblDirectory",str,"/ressources/ftp.ensembl.org/pub/release-41/mart_41/data/mysql/ensembl_mart_41/"), \
