...
def translateGenome(genome, nom, genesAnc):
...
for e in s:
	genomes[e] = translateGenome(geneBank.dicEspeces[e], e, genesAnc)

genomes['T'] = translateGenome(genomeOutgroup, 'T', genesAnc)
genomes['A'] = translateGenome(genomeMammals, 'A', genesAnc)
s += 'AT'
