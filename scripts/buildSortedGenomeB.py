...
(noms_fichiers, options) = utils.myTools.checkArgs( \
	...
	[("ancestr",str,""), ("seuilMaxDistInterGenes",float,0), ("nbDecimales",int,2), ("penalite",int,1000000), ("notConstraintPenalty",float,0), \
...
for c in genesAnc.lstChr:
	...
	def f(i, j):
		...
		if y == None:
			...
			return int(mult*(y+options["notConstraintPenalty"]))
